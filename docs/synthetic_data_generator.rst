...
Instead of generating trajectories from scratch, you can download the labelled dataset
that was produced with TrajPy and is publicly available on Zenodo:
...
The dataset covers four trajectory classes — **normal diffusion**, **direct motion**,
**anomalous diffusion** and **confined diffusion** — and provides the following
...
.. tip::
   You can load the dataset directly with pandas and use it with any
